...
with open('/home/ashwath/Files/OpenCitations/data.csv','r') as csvfile, open('opencit_mag_mapping2.tsv', 'w') as outfile, open('opencit_not_in_mag.txt', 'a') as notfoundfile:
